  ...
  allProject: IApp[] = [
    {
      ...
      Files: [
        { file: 'ecommerce/1.png', type: 'image', id: '1' },
        { file: 'ecommerce/2.png', type: 'image', id: '2' },
        { file: 'ecommerce/3.png', type: 'image', id: '3' },
        { file: 'ecommerce/4.png', type: 'image', id: '4' },
        { file: 'ecommerce/5.png', type: 'image', id: '5' },
      ],
      category: 'web sites',
    },
  ];

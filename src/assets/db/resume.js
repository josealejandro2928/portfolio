let data = {
  initialText: `
   <p>
      ...
      the use of javascript frameworks. I have also done robotics work and taught classes at the Technological
  ...
  vocationalEmployment: [
    {
      ...
      startDate: "2018",
      endDate: "2019",
      description: `Design of a <strong>Two Wheel Self Balancing Robot</strong>:
    ...
    },
    {
      ...
      startDate: "2018",
      endDate: "2019",
      description: `Development of a <strong>simulator for an inverted pendulum system</strong>:
